...
namespace FabricaCEAPE.Vistas
{
    public partial class FrmEntregaProducto : Form
    {
        ...
        {
            txtTipoProducto.Text = ((ProductoTerminado)cbProducto.SelectedItem).Producto.Nombre.ToString();
            txtStock.Text = ((ProductoTerminado)cbProducto.SelectedItem).Stock.ToString();
            this.numCantidad.Value = 1;
        }
        ...
        private void consulta()
        {
            ...
            if (may >= men)
            {
                errorProvider1.SetError(numCantidad, "La cantidad a agregar debe ser menor al Stock actual");
                //result = false;
        ...
        {
            txtTipoProducto.Text = ((ProductoTerminado)cbProducto.SelectedItem).NombreTipoProducto.ToString();
            txtStock.Text = ((ProductoTerminado)cbProducto.SelectedItem).Stock.ToString();
            this.numCantidad.Value = 1;
        }
    }
